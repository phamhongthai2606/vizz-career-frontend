...
export default function BusinessHeader() {
  ...
  // Login?
  const notLoginPages = ["/business/business-login", "/business/registration, business/forgot-password", "/business/email-sent", "/business/account-created", "/business/set-password"];
  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center justify-center gap-x-10">
        {!isLoggedIn && pathCurrent !== "/business/business-login" &&
          pathCurrent !== "/business/forgot-password"
          && pathCurrent !== "/business/email-sent"
          && pathCurrent !== "/business/set-password"
          && pathCurrent !== "/business/account-created"
          ? (
          <AppPrimaryLinkButton
            label="ログイン"
            href="/business/business-login"
          />
        ) : isLoggedIn && pathCurrent !== "/business/forgot-password" ? (
