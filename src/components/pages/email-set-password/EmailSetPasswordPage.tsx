    ...
    <div className="flex min-h-screen flex-col items-center justify-start bg-[#f9fafb] px-4 pt-2.5">
      <div className="flex w-full max-w-[480px] flex-col">
        ...
        >
          ...
          <button
            type="submit"
            className="flex h-10 w-60 items-center justify-center gap-3 rounded-[34px] bg-[#FFE5E5] px-4 py-2 text-sm font-normal tracking-[1.4px] text-[#FF9999] transition-opacity"
          >
            メールを送信
          </button>
        </form>
